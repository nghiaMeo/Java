				...
				<div class="electronics-login-register">
					<ul>
						<c:if test="${username == null}" >
							<li><button class= "button_1"><a href="${pageContext.request.contextPath }/user/account/login"><i class="fas fa-sign-in-alt"></i>Login</a></button>
							</li>
							<li><button class= "button_1"><a href="${pageContext.request.contextPath }/user/account/register"><i class="fas fa-user-plus"></i>Register</a></button></li>
						</c:if>
						<c:if test="${username != null}" >
							<c:if test="${roleId != null}">
								<c:if test="${roleId == 1 }">
									<li><button class="button_1"><a href="${pageContext.request.contextPath }/user/account/profile" title="Profile"><i class="pe-7s-users"></i>Hello ${username }</a></button></li>
								</c:if>
								<c:if test="${roleId == 2 }">
									<li><button class="button_1"><a href="${pageContext.request.contextPath }/manager/profile/index" title="Admin"><i class="pe-7s-users"></i>Hello ${username }</a></button></li>
								</c:if>
							</c:if>
							<li><button class="button_1"><a href="${pageContext.request.contextPath }/user/cart/transaction"><i class="fas fa-cart-arrow-down"></i>Transactions</a></button></li>
							<li><button class="button_1"><a href="${pageContext.request.contextPath }/user/account/logout"><i class="fas fa-sign-out-alt"></i>Logout</a></button></li>
						</c:if>
					</ul>
				</div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-xl-4">
						<div class="footer-widget mb-40">
							<h3 class="footer-widget-title-3">${contact.name }</h3>
